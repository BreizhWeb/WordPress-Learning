...
Kirki::add_field( 'start', array(
  ...
  'output'    => array(
    array(
      'element'  => '.site-footer .footer-area .footer-one, .site-footer .footer-area .footer-two, .site-footer .footer-area .footer-three, .site-footer .footer-area .footer-four',
      'property' => 'padding',
    ),
  ),
) );